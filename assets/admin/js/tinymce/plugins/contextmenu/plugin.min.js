tinymce.PluginManager.add("contextmenu", function (e) {
	var t, n, r = e.settings.contextmenu_never_use_native, i = function (e) {
		return e.ctrlKey && !r
	}, o        = function () {
	...
	return e.on("mousedown", function (t) {
		...
		var o;
		if (!i(r)) {
			if (r.preventDefault(), o = e.settings.contextmenu || "link openlink image inserttable | cell row column deletetable", t)t.show(); else {
				var a = [];
