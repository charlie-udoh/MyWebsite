	...
	s("1", tinymce.PluginManager), s("6", tinymce.util.Delay), s("e", tinymce.util.Tools), s("9", tinymce.html.SaxParser), s("a", tinymce.html.Schema), s("b", tinymce.dom.DOMUtils.DOM), a("h", [], function () {
		...
		var a = function (a, s) {
			...
			if (c.source2 || (c.source2 = ""), c.poster || (c.poster = ""), c.source1 = a.convertURL(c.source1, "source"), c.source2 = a.convertURL(c.source2, "source"), c.source1mime = e.guess(c.source1), c.source2mime = e.guess(c.source2), c.poster = a.convertURL(c.poster, "poster"), o.each(n.urlPatterns, function (e) {
				...
				}), c.embed)l = i.updateHtml(c.embed, c, !0); else {
		...
		var l = a.ie && a.ie <= 8 ? "onChange" : "onInput", c = function (e) {
			return function (t) {
			...
			return function (r) {
				var i = r.html, a = e.find("#embed")[0], l = o.extend(t.htmlToData(n.settings.media_scripts, i), {source1: r.url});
			...
			var i = e.toJSON();
			i.embed = n.updateHtml(i.embed, i), i.embed ? m(t, i.embed) : r.getEmbedHtml(t, i).then(function (e) {
				m(t, e.html)
			})["catch"](c(t))
		}, g  = function (e, t) {
			...
			var i, a, p = [{
				...
				onpaste     : function () {
					setTimeout(function () {
						r.getEmbedHtml(e, i.toJSON()).then(f(i, e))["catch"](c(e))
					}, 1)
				},
				onchange    : function (t) {
					r.getEmbedHtml(e, i.toJSON()).then(f(i, e))["catch"](c(e)), g(i, t.meta)
				},
			...
			if (e.settings.media_alt_source !== !1 && m.push({
					name    : "source2",
					type    : "filepicker",
					filetype: "media",
					size    : 40,
			...
			y[l] = C, i = e.windowManager.open({
				...
				body    : [{title: "General", type: "form", items: p}, {
					...
					padding  : 10,
					spacing  : 10,
					items    : [{type: "label", text: "Paste your embed code below:", forId: "mcemediasource"}, y]
				}, {title: "Advanced", type: "form", items: m}],
				onSubmit: function () {
					s.updateSize(i), h(i, e)
				}
			}), s.syncSize(i)
		};
		return {showDialog: v}
		...
		var o = function (e) {
			e.on("ResolveName", function (e) {
				...
				tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
					...
					for (var i, o, a, s, l, c, u, d, f = t.length; f--;)if (i = t[f], i.parent) {
