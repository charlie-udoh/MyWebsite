!function (e, t) {
	...
	r("tinymce/tableplugin/Utils", ["tinymce/Env"], function (e) {
		...
		var n = function (e, t, n) {
			...
			var a, s, l = 0, c = r(e, t, i);
			for (a = i; (o > 0 ? a < e.length : a >= 0) && (s = n(e, t, a), c === s.elm); a += o)l++;
			return l
		}, o  = function (e, t, n) {
			for (var r, i = e[n], o = t; o < i.length; o++)if (r = i[o], r.real)return r.elm;
			return null
		}, a  = function (e, n) {
			...
			var r = e.elm.ownerDocument, i = r.createElement("td");
			...
			var s = a(t, i), l = r(t, n, i).parentNode, d = [];
		...
		var o = e.each, a = r.getSpanVal, s = r.setSpanVal;
		return function (l, c, u) {
			...
			function m() {
				var e = 0;
				Q = [], Z = 0, o(["thead", "tbody", "tfoot"], function (t) {
					var n = p(c, t)[0], r = p(n, "tr");
					o(r, function (n, r) {
						r += e, o(p(n, "td,th"), function (e, n) {
							var i, o, s, l;
							if (Q[r])for (; Q[r][n];)n++;
							for (s = a(e, "rowspan"), l = a(e, "colspan"), o = r; o < r + s; o++)for (Q[o] || (Q[o] = []), i = n; i < n + l; i++)Q[o][i] = {
								part   : t,
								real   : o == r && i == n,
								elm    : e,
								rowspan: s,
			...
			function h(e) {
				return l.fire("newrow", {node: e}), e
			}

			function g(e) {
				return l.fire("newcell", {node: e}), e
			}
			...
			function S(t) {
				...
				}, "childNodes"), t = v(t, !1), g(t), s(t, "rowSpan", 1), s(t, "colSpan", 1), i ? t.appendChild(i) : r.paddCell(t), t
			}
			...
			function _() {
				...
				}), m(), void(ee && (e = Q[Math.min(Q.length - 1, ee.y)], e && (ne.select(e[Math.min(e.length - 1, ee.x)].elm, !0), ne.collapse(!0)))))
			}

			function k(e, t, n, r) {
				var i, o, a, s, l;
				for (i = Q[t][e].elm.parentNode, a = 1; a <= n; a++)if (i = re.getNext(i, "tr")) {
					for (o = e; o >= 0; o--)if (l = Q[t + a][o].elm, l.parentNode == i) {
						for (s = 1; s <= r; s++)re.insertAfter(S(l), l);
						break
					}
					if (o == -1)for (s = 1; s <= r; s++)i.insertBefore(S(i.cells[0]), i.cells[0])
				}
			}
			...
			function T() {
				o(Q, function (e, t) {
					o(e, function (e, n) {
						var r, i, o;
						if (x(e) && (e = e.elm, r = a(e, "colspan"), i = a(e, "rowspan"), r > 1 || i > 1)) {
			...
			function M(t, n, r) {
				var i, a, l, c, u, d, f, p, h, g, v, y, C;
				if (t ? (i = q(t), a = i.x, l = i.y, c = a + (n - 1), u = l + (r - 1)) : (ee = te = null, o(Q, function (e, t) {
						o(e, function (e, n) {
							x(e) && (ee || (ee = {x: n, y: t}), te = {x: n, y: t})
						})
					}), ee && (a = ee.x, l = ee.y, c = te.x, u = te.y)), p = b(a, l), h = b(c, u), p && h && p.part == h.part) {
					T(), m(), y = P(Q, a, l, c, u), C = D(Q, a, l, c, u), p = b(a, l).elm;
					var w = c - a - C + 1, N = u - l - y + 1;
					for (w === Z && N === Q.length && (w = 1, N = 1), w === Z && N > 1 && (N = 1), s(p, "colSpan", w), s(p, "rowSpan", N), f = l; f <= u; f++)for (d = a; d <= c; d++)Q[f] && Q[f][d] && (t = Q[f][d].elm, t != p && (g = e.grep(t.childNodes), o(g, function (e) {
						p.appendChild(e)
					}), g.length && (g = e.grep(p.childNodes), v = 0, o(g, function (e) {
						"BR" == e.nodeName && v++ < g.length - 1 && p.removeChild(e)
					})), re.remove(t)));
					_()
				}
			}
			...
			function L(e) {
				...
				if (o(Q, function (r, i) {
						if (o(r, function (t) {
								if (x(t) && (t = t.elm, c = t.parentNode, u = h(v(c, !1)), n = i, e))return !1
							}), e)return n === t
					}), n !== t) {
					for (l = 0, m = 0; l < Q[0].length; l += m)if (Q[n][l] && (r = Q[n][l].elm, m = a(r, "colspan"), r != i)) {
						if (e) {
							if (n > 0 && Q[n - 1][l] && (f = Q[n - 1][l].elm, p = a(f, "rowSpan"), p > 1)) {
								s(f, "rowSpan", p + 1);
								continue
							}
			...
			function O(e) {
				...
				o(Q, function (r) {
					if (o(r, function (t, r) {
							if (x(t) && (n = r, e))return !1
						}), e)return n === t
				}), o(Q, function (t, i) {
					var o, l, c;
					t[n] && (o = t[n].elm, o != r && (c = a(o, "colspan"), l = a(o, "rowspan"), 1 == c ? e ? (o.parentNode.insertBefore(S(o), o), k(n, i, l - 1, c)) : (re.insertAfter(S(o), o), k(n, i, l - 1, c)) : s(o, "colSpan", o.colSpan + 1), r = o))
				})
			}
			...
			function W() {
				var t = [];
				if (f(c)) {
					if (1 == Q[0].length)return;
					if (F(Q).length == z(Q).length)return
				}
				o(Q, function (n) {
					o(n, function (n, r) {
						x(n) && e.inArray(t, r) === -1 && (o(Q, function (e) {
							var t, n = e[r].elm;
			...
			function U() {
				function e(e) {
					...
					o(e.cells, function (e) {
						var n = a(e, "rowSpan");
						n > 1 && (s(e, "rowSpan", n - 1), t = q(e), k(t.x, t.y, 1, 1))
					}), t = q(e.cells[0]), o(Q[t.y], function (e) {
						var t;
			...
			function j(t, n) {
				var r, a, l;
				t && (r = i.splitAt(Q, ee.x, ee.y, n), a = r.row, e.each(r.cells, g), l = e.map(t, function (e) {
					return e.cloneNode(!0)
				}), n || l.reverse(), o(l, function (e) {
					var t, r, i = e.cells.length;
					for (h(e), t = 0; t < i; t++)r = e.cells[t], g(r), s(r, "colSpan", 1), s(r, "rowSpan", 1);
					for (t = i; t < Z; t++)e.appendChild(g(S(e.cells[i - 1])));
					for (t = Z; t < i; t++)re.remove(e.cells[t]);
			...
			function q(e) {
				var t;
				return o(Q, function (n, r) {
					return o(n, function (n, i) {
						if (n.elm == e)return t = {x: i, y: r}, !1
					}), !t
				}), t
			}
			...
			function X() {
				var e, t;
				return e = t = 0, o(Q, function (n, r) {
					o(n, function (n, i) {
						var o, a;
						x(n) && (n = Q[r][i], i > e && (e = i), r > t && (t = r), n.real && (o = n.colspan - 1, a = n.rowspan - 1, o && i + o > e && (e = i + o), a && r + a > t && (t = r + a)))
					})
				}), {x: e, y: t}
			}
			...
			function K(e) {
				...
				if (te = q(e), ee && te) {
					for (t = Math.min(ee.x, te.x), n = Math.min(ee.y, te.y), r = Math.max(ee.x, te.x), i = Math.max(ee.y, te.y), o = r, a = i, u = n; u <= i; u++)for (c = t; c <= r; c++)e = Q[u][c], e.real && (s = e.colspan - 1, l = e.rowspan - 1, s && c + s > o && (o = c + s), l && u + l > a && (a = u + l));
					for (d(), u = n; u <= a; u++)for (c = t; c <= o; c++)Q[u][c] && re.setAttrib(Q[u][c].elm, "data-mce-selected", "1")
				}
			}
			...
			function G(e, t) {
				...
				n = q(e), r = n.y * Z + n.x;
				do {
					if (r += t, i = b(r % Z, Math.floor(r / Z)), !i)break;
			...
			function J(t) {
				if (ee) {
					var n = i.splitAt(Q, ee.x, ee.y, t);
					e.each(n.cells, g)
				}
			}

			var Q, Z, ee, te, ne = l.selection, re = ne.dom;
		...
		return function (s) {
			function l() {
				function n(n) {
					...
					function v(e, t, n, r) {
						var i = h(s.dom.getParent(t, "td,th")), o = g(n, i), a = n.childNodes[o], l = d(a, r);
						f(l || a)
					}
					...
					var C = n.keyCode;
					if (p() && m(s)) {
						var x = s.selection.getNode();
						t.setEditorTimeout(s, function () {
							b(x) && r(!n.shiftKey && C === e.UP, x, n)
						}, 0)
					}
				}
			...
			function p() {
				var t = function (e) {
					...
					var n = s.selection.getRng(), r = e.ownerDocument.createTextNode("\xa0");
		...
		return function (r, i) {
			function o(e) {
				r.getBody().style.webkitUserSelect = "", (e || h) && (r.$("td[data-mce-selected],th[data-mce-selected]").removeAttr("data-mce-selected"), h = !1)
			}
			...
			function s(t) {
				var n, o, s = t.target;
				if (!f && !p && s !== d && (d = s, u && c)) {
					if (o = m.getParent(s, "td,th"), a(u, o) || (o = m.getParent(u, "td,th")), c === o && !h)return;
					if (i(!0), a(u, o)) {
						t.preventDefault(), l || (l = new e(r, u, c), r.getBody().style.webkitUserSelect = "none"), l.setEndCell(o), h = !0, n = r.selection.getSel();
						try {
			...
			var l, c, u, d, f, p, m = r.dom, h = !0, g = function () {
				c = l = u = d = null, i(!1)
			};
			return r.on("SelectionChange", function (e) {
				...
				if (c) {
					if (l && (r.getBody().style.webkitUserSelect = ""), o = m.select("td[data-mce-selected],th[data-mce-selected]"), o.length > 0) {
						...
						do if ("TD" == s.nodeName || "TH" == s.nodeName) {
		...
		return function (r) {
			...
			m.tableProps = function () {
				...
				function c() {
					function n(e, t, r) {
						if ("TD" === e.tagName || "TH" === e.tagName)x.setStyle(e, t, r); else if (e.children)for (var i = 0; i < e.children.length; i++)n(e.children[i], t, r)
					}

					var i;
					d(x, this), w = e.extend(w, this.toJSON()), w["class"] === !1 && delete w["class"], r.undoManager.transact(function () {
						if (h || (h = r.plugins.table.insertTable(w.cols || 1, w.rows || 1)), r.dom.setAttribs(h, {
								style  : w.style,
								"class": w["class"]
							}), r.settings.table_style_by_css) {
							if (C = [], C.push({name: "border", value: w.border}), C.push({
									name : "border-spacing",
									value: s(w.cellspacing)
								}), p(x, h, C), x.setAttribs(h, {
									"data-mce-border-color": w.borderColor,
									"data-mce-cell-padding": w.cellpadding,
									"data-mce-border"      : w.border
								}), h.children)for (var e = 0; e < h.children.length; e++)n(h.children[e], "border", w.border), n(h.children[e], "padding", s(w.cellpadding))
						} else r.dom.setAttribs(h, {
							border     : w.border,
							cellpadding: w.cellpadding,
							cellspacing: w.cellspacing
						});
						x.getAttrib(h, "width") && !r.settings.table_style_by_css ? x.setAttrib(h, "width", a(w.width)) : x.setStyle(h, "width", s(w.width)), x.setStyle(h, "height", s(w.height)), i = x.select("caption", h)[0], i && !w.caption && x.remove(i), !i && w.caption && (i = x.create("caption"), i.innerHTML = t.ie ? "\xa0" : '<br data-mce-bogus="1"/>', h.insertBefore(i, h.firstChild)), l(h), w.align && r.formatter.apply("align" + w.align, {}, h), r.focus(), r.addVisual()
					})
				}
				...
				var h, g, v, b, y, C, x = r.dom, w = {};
				i === !0 ? (h = x.getParent(r.selection.getStart(), "table"), h && (w = {
					width      : a(x.getStyle(h, "width") || x.getAttrib(h, "width")),
					height     : a(x.getStyle(h, "height") || x.getAttrib(h, "height")),
					cellspacing: a(x.getStyle(h, "border-spacing") || x.getAttrib(h, "cellspacing")),
					cellpadding: x.getAttrib(h, "data-mce-cell-padding") || x.getAttrib(h, "cellpadding") || m(h, "padding"),
					border     : x.getAttrib(h, "data-mce-border") || x.getAttrib(h, "border") || m(h, "border"),
					borderColor: x.getAttrib(h, "data-mce-border-color"),
					caption    : !!x.select("caption", h)[0],
					"class"    : x.getAttrib(h, "class")
				}, n("left center right".split(" "), function (e) {
					r.formatter.matchNode(h, "align" + e) && (w.align = e)
					...
					items       : [{
						...
						items       : r.settings.table_appearance_options !== !1 ? [g, v, {
							label: "Width",
							name : "width"
							...
							label: "Border",
							name : "border"
						}, {label: "Caption", name: "caption", type: "checkbox"}] : [g, v, {
							label: "Width",
							name : "width"
						}, {label: "Height", name: "height"}]
					}, {
				...
				}, r.settings.table_advtab !== !1 ? (f(x, w, h), r.windowManager.open({
					...
					onsubmit: c
				})) : r.windowManager.open({title: "Table properties", data: w, body: y, onsubmit: c})
				...
				function p() {
					d(v, this), h = e.extend(h, this.toJSON()), r.undoManager.transact(function () {
						n(b, function (e) {
							t(e, "scope", h.scope), t(e, "style", h.style), t(e, "class", h["class"]), i(e, "width", s(h.width)), i(e, "height", s(h.height)), h.type && e.nodeName.toLowerCase() !== h.type && (e = v.rename(e, h.type)), 1 === b.length && (l(e), c(e)), h.align && r.formatter.apply("align" + h.align, {}, e), h.valign && r.formatter.apply("valign" + h.valign, {}, e)
						}), r.focus()
					})
				}
				...
				if (b = r.dom.select("td[data-mce-selected],th[data-mce-selected]"), m = r.dom.getParent(r.selection.getStart(), "td,th"), !b.length && m && b.push(m), m = m || b[0]) {
					...
					}, h.type = m.nodeName.toLowerCase(), n("left center right".split(" "), function (e) {
						r.formatter.matchNode(m, "align" + e) && (h.align = e)
					}), n("top middle bottom".split(" "), function (e) {
						r.formatter.matchNode(m, "valign" + e) && (h.valign = e)
					}), f(v, h, m)), r.settings.table_cell_class_list && (g = {
						name  : "class",
						type  : "listbox",
						label : "Class",
					...
					r.settings.table_cell_advtab !== !1 ? r.windowManager.open({
						...
						onsubmit: p
					}) : r.windowManager.open({title: "Cell properties", data: h, body: y, onsubmit: p})
				}
			}, m.row = function () {
				function t(e, t, n) {
					(1 === C.length || n) && y.setAttrib(e, t, n)
				}

				function i(e, t, n) {
					(1 === C.length || n) && y.setStyle(e, t, n)
				}
				...
				p = r.dom.getParent(r.selection.getStart(), "table"), m = r.dom.getParent(r.selection.getStart(), "td,th"), n(p.rows, function (e) {
					n(e.cells, function (t) {
						if (y.getAttrib(t, "data-mce-selected") || t == m)return C.push(e), !1
					})
				}), h = C[0], h && (C.length > 1 ? v = {
					height : "",
					scope  : "",
					"class": "",
					align  : "",
					...
					height : a(y.getStyle(h, "height") || y.getAttrib(h, "height")),
					scope  : y.getAttrib(h, "scope"),
					"class": y.getAttrib(h, "class")
				}, v.type = h.parentNode.nodeName.toLowerCase(), n("left center right".split(" "), function (e) {
					r.formatter.matchNode(h, "align" + e) && (v.align = e)
				}), f(y, v, h)), r.settings.table_row_class_list && (g = {
					name  : "class",
					type  : "listbox",
					label : "Class",
					...
					onsubmit: c
				}) : r.windowManager.open({title: "Row properties", data: v, body: b, onsubmit: c}))
			}
		}
		...
		return function (i) {
			function o(e, t) {
				return {index: e, y: i.dom.getPos(t).y}
			}

			function a(e, t) {
				return {index: e, y: i.dom.getPos(t).y + t.offsetHeight}
			}

			function s(e, t) {
				return {index: e, x: i.dom.getPos(t).x}
			}

			function l(e, t) {
				return {index: e, x: i.dom.getPos(t).x + t.offsetWidth}
			}
			...
			function m(e, t) {
				return h(e, "width") / h(t, "width") * 100
			}

			function h(e, t) {
				var n = i.dom.getStyle(e, t, !0), r = parseInt(n, 10);
				return r
			}

			function g(e) {
				var t = h(e, "width"), n = h(e.parentElement, "width");
				return t / n * 100
			}
			...
			function N(t, n, r) {
				e.each(t, function (e) {
					var t = r.x, o = e.y - xe / 2, a = xe, s = n;
					i.dom.add(d(), "div", w(pe, me, t, o, a, s, he, e.index))
				})
			}

			function E(t, n, r) {
				e.each(t, function (e) {
					var t = e.x - xe / 2, o = r.y, a = n, s = xe;
			...
			function R(t) {
				var n = k(0, t.grid.maxCols), r = k(0, t.grid.maxRows);
			...
			function B(e) {
				var t = S(e), n = _(t), r = A(n), s = R(n), l = i.dom.getPos(e), c = r.length > 0 ? y(o, a, r) : [], u = s.length > 0 ? y(f, p, s) : [];
				N(c, e.offsetWidth, l), E(u, e.offsetHeight, l)
			}
			...
			function P(e, t, n, r) {
				...
				if (i)i = {
					value: i,
					delta: 0
				}; else for (var o = e.slice(0, t).reverse(), a = 0; a < o.length; a++)o[a] && (i = {
					value: o[a],
					delta: a + 1
				});
				var s = e[t + 1];
				if (s)s = {
					value: s,
					delta: 1
				}; else for (var l = e.slice(t + 1), c = 0; c < l.length; c++)l[c] && (s = {value: l[c], delta: c + 1});
				var u = s.delta - i.delta, d = Math.abs(s.value - i.value) / u;
				return n ? d / h(r, "width") * 100 : d
			}
			...
			function M(e, t, n) {
				var r = D(e, "width"), i = parseInt(r, 10), o = t ? m(e, n) : h(e, "width");
			...
			function L(t, n, r) {
				for (var i = R(t), o = e.map(i, function (e) {
					...
					var l = i[s].element.hasAttribute("colspan") ? parseInt(i[s].element.getAttribute("colspan"), 10) : 1, c = l > 1 ? P(o, s) : M(i[s].element, n, r);
					c = c ? c : we, a.push(c)
				}
				return a
			}
			...
			function I(e) {
				...
				return V(t) && (n = 0), !isNaN(n) && n > 0 ? n : h(e, "height")
			}
			...
			function O(t) {
				for (var n = A(t), r = e.map(n, function (e) {
					...
					var s = n[a].element.hasAttribute("rowspan") ? parseInt(n[a].element.getAttribute("rowspan"), 10) : 1, l = s > 1 ? P(r, a) : I(n[a].element);
					l = l ? l : Ne, i.push(l)
				}
				return i
			}
			...
			function j(t, n, r) {
				...
				function a() {
					return r < u.grid.maxCols - 1 ? g(t) : g(t) + b(t, n)
				}

				function s() {
					return r < u.grid.maxCols - 1 ? h(t, "width") : h(t, "width") + n
				}
				...
				for (var c = S(t), u = _(c), d = V(t.width) || V(t.style.width), f = L(u, d, t), p = d ? v(t, n) : n, m = H(f, r, p, we, d, t), y = [], C = 0; C < m.length; C++)y.push(m[C] + f[C]);
				var x = z(u, y), w = d ? "%" : "px", N = d ? a() : s();
			...
			function J() {
				if (i.dom.remove(le), se) {
					i.dom.removeClass(ce, Ee), se = !1;
					var e, t;
					if (Z(ce)) {
						var n = parseInt(i.dom.getAttrib(ce, Ce), 10), o = i.dom.getPos(ce).x;
						e = parseInt(i.dom.getAttrib(ce, ye), 10), t = c() ? n - o : o - n, Math.abs(t) >= 1 && j(r, t, e)
					} else if (ee(ce)) {
						var a = parseInt(i.dom.getAttrib(ce, ge), 10), s = i.dom.getPos(ce).y;
						e = parseInt(i.dom.getAttrib(ce, he), 10), t = s - a, Math.abs(t) >= 1 && q(r, t, e)
					}
					x(r), i.nodeChanged()
				}
			}
			...
			function Q(e, t) {
				le = le ? le : K(), se = !0, i.dom.addClass(e, Ee), ce = e, G(le, t), i.dom.add(d(), le)
			}
			...
			function oe(e) {
				var t = e.target, n = i.getBody();
				if (i.$.contains(n, r) || r === n)if (Z(t)) {
					e.preventDefault();
					var o = i.dom.getPos(t).x;
					i.dom.setAttrib(t, Ce, o), re(t)
				} else if (ee(t)) {
					e.preventDefault();
					var a = i.dom.getPos(t).y;
					i.dom.setAttrib(t, ge, a), ie(t)
				} else C()
			}

			var ae, se, le, ce, ue, de, fe = "mce-resize-bar", pe = "mce-resize-bar-row", me = "row-resize", he = "data-row", ge = "data-initial-top", ve = "mce-resize-bar-col", be = "col-resize", ye = "data-col", Ce = "data-initial-left", xe = 4, we = 10, Ne = 10, Ee = "mce-resize-bar-dragging", Se = new RegExp(/(\d+(\.\d+)?%)/), _e = new RegExp(/px|em/);
			return i.on("init", function () {
				...
				if (!se) {
					...
					("TABLE" === e.target.nodeName || t) && (r = t, x(t))
				}
		...
		function c(o) {
			...
			function l(e, t) {
				...
				return i += "</tbody></table>", o.undoManager.transact(function () {
					o.insertContent(i), a = o.dom.get("__mce"), o.dom.setAttrib(a, "id", null), o.$("tr", a).each(function (e, t) {
						o.fire("newrow", {node: t}), o.$("th,td", t).each(function (e, t) {
							o.fire("newcell", {node: t})
						})
			...
			function h(e, t, n) {
				...
				for (c.nextSibling.innerHTML = e + 1 + " x " + (t + 1), u && (e = 9 - e), i = 0; i < 10; i++)for (r = 0; r < 10; r++)s = c.rows[i].childNodes[r].firstChild, l = (u ? r >= e : r <= e) && i <= t, o.dom.toggleClass(s, "mce-active", l), l && (a = s);
				return a.parentNode
			}
			...
			function g() {
				...
				}), o.addButton("tabledeletecol", {title: "Delete column", onclick: a("mceTableDeleteCol")})
			}
			...
			!o.settings.object_resizing || o.settings.table_resize_bars === !1 || o.settings.object_resizing !== !0 && "table" !== o.settings.object_resizing || (w = i(o)), o.settings.table_grid === !1 ? o.addMenuItem("inserttable", {
				...
				ariaHideMenu: !0,
				onclick     : function (e) {
					e.aria && (this.parent().hideAll(), e.stopImmediatePropagation(), E.table())
				},
				onshow      : function () {
					h(0, 0, this.menu.items()[0])
				},
				onhide      : function () {
				...
				menu        : [{
					type          : "container", html: m(), onPostRender: function () {
						...
						var t, n, r = e.target;
						"A" == r.tagName.toUpperCase() && (t = parseInt(r.getAttribute("data-mce-x"), 10), n = parseInt(r.getAttribute("data-mce-y"), 10), (this.isRtl() || "tl-tr" == this.parent().rel) && (t = 9 - t), t === this.lastX && n === this.lastY || (h(t, n, e.control), this.lastX = t, this.lastY = n))
					}, onclick    : function (e) {
						var t = this;
				...
				menu     : [{
					...
					onclick     : a("mceTableCellProps"),
					onPostRender: f
				}, {text: "Merge cells", onclick: a("mceTableMergeCells"), onPostRender: p}, {
					text        : "Split cell",
					onclick     : a("mceTableSplitCells"),
					onPostRender: f
				}]
				...
				menu   : [{
					...
					onclick     : a("mceTablePasteRowBefore"),
					onPostRender: f
				}, {text: "Paste row after", onclick: a("mceTablePasteRowAfter"), onPostRender: f}]
			...
			u("inserttable tableprops deletetable | cell row column".split(" "), function (e) {
				"|" == e ? S.push({text: "-"}) : S.push(o.menuItems[e])
			}), o.addButton("table", {
				type : "menubutton",
				title: "Table",
				menu : S
				...
				mceTableSplitCells        : function (e) {
					...
					var t;
					t = o.dom.getParent(o.selection.getStart(), "th,td"), o.dom.select("td[data-mce-selected],th[data-mce-selected]").length ? e.merge() : E.merge(e, t)
				...
				mceInsertTable     : E.table, mceTableProps: function () {
					E.table(!0)
				}, mceTableRowProps: E.row, mceTableCellProps: E.cell
			}, function (e, t) {
				o.addCommand(t, function (t, n) {
					e(n)
				})
			}), g(), b(), o.settings.table_tab_navigation !== !1 && o.on("keydown", function (t) {
				var n, r, i;
			...
			}), N.insertTable = l, N.setClipboardRows = C, N.getClipboardRows = y
		}
