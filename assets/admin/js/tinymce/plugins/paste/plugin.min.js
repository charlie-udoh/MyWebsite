!function (e, t) {
	...
	r("tinymce/pasteplugin/Utils", ["tinymce/util/Tools", "tinymce/html/DomParser", "tinymce/html/Schema"], function (e, t, n) {
		...
		return {isImageUrl: n, isAbsoluteUrl: t, insertContent: c}
		...
		return function (a) {
			...
			function c() {
				...
				if (S = a.selection.getRng(), a.inline && (n = a.selection.getScrollContainer(), n && n.scrollTop > 0 && (s = n.scrollTop)), S.getClientRects) {
					var c = t(S);
					if (c)l = s + (c.top - r.getPos(i).y); else {
						l = s;
						var u = S.startContainer;
						u && (3 == u.nodeType && u.parentNode != i && (u = u.parentNode), 1 == u.nodeType && (l = r.getPos(u, n || i).y))
					}
				}
				E = r.add(a.getBody(), "div", {
					id              : "mcepastebin",
					contentEditable : !0,
					"data-mce-bogus": "all",
					style           : "position: absolute; top: " + l + "px;width: 10px; height: 10px; overflow: hidden; opacity: 0"
				}, A), (e.ie || e.gecko) && r.setStyle(E, "left", "rtl" == r.getStyle(i, "direction", !0) ? 65535 : -65535), r.bind(E, "beforedeactivate focusin focusout", function (e) {
					e.stopPropagation()
				}), E.focus(), a.selection.select(E, !0)
			}
			...
			function v(e, t, n) {
				...
				var r = t.result, i = h(r), o = new Image;
			...
			function N() {
				function t(e, t, n) {
					var i;
					return x(e, "text/html") ? i = e["text/html"] : (i = d(), i == A && (n = !0)), i = r.trimHtml(i), E && E.firstChild && "mcepastebin" === E.firstChild.id && (n = !0), u(), i.length || (n = !0), n && (i = x(e, "text/plain") && i.indexOf("</p>") == -1 ? e["text/plain"] : r.innerText(i)), i == A ? void(t || a.windowManager.alert("Please use Ctrl+V/Cmd+V keyboard shortcuts to paste contents.")) : void(n ? l(i) : s(i))
				}
				...
				a.on("keydown", function (t) {
					...
					if (w(t) && !t.isDefaultPrevented()) {
						...
						if (t.stopImmediatePropagation(), T = (new Date).getTime(), e.ie && _)return t.preventDefault(), void a.fire("paste", {ieFake: !0});
				...
				a.on("paste", function (n) {
					var r = (new Date).getTime(), s = p(n), l = (new Date).getTime() - r, f = (new Date).getTime() - T - l < 1e3, h = "text" == k.pasteFormat || _;
					return _ = !1, n.isDefaultPrevented() || y(n) ? void u() : !m(s) && b(n, i()) ? void u() : (f || n.preventDefault(), !e.ie || f && !n.ieFake || (c(), a.dom.bind(E, "paste", function (e) {
						e.stopPropagation()
					}), a.getDoc().execCommand("Paste", !1, null), s["text/html"] = d()), void(x(s, "text/html") ? (n.preventDefault(), t(s, f, h)) : o.setEditorTimeout(a, function () {
						t(s, f, h)
					}, 0)))
					...
					var t, i;
					if (i = C(e), !e.isDefaultPrevented() && !R && (t = f(e.dataTransfer), (m(t) && !n(t) || !b(e, i)) && i && a.settings.paste_filter_drop !== !1)) {
			...
			var E, S, _, k = this, T = 0, R = !1, A = "%MCEPASTEBIN%", B = "data:text/mce-internal,", P = r.createIdGenerator("mceclip");
			k.pasteHtml = s, k.pasteText = l, k.pasteImageData = b, a.on("preInit", function () {
				N(), a.parser.addNodeFilter("img", function (t, n, r) {
					...
					if (!a.settings.paste_data_images && i(r))for (var c = t.length; c--;) {
		...
		function c(c) {
			...
			c.on("BeforePastePreProcess", function (d) {
				function f(e) {
					...
					for (var a, c, u = 1, d = [], f = e.firstChild; "undefined" != typeof f && null !== f;)if (d.push(f), f = f.walk(), null !== f)for (; "undefined" != typeof f && f.parent !== e;)f = f.walk();
					for (var p = 0; p < d.length; p++)if (e = d[p], "p" == e.name && e.firstChild) {
						...
						if (s(m)) {
							var h = /([0-9]+)\./.exec(m), g = 1;
							h && (g = parseInt(h[1], 10)), o(e, "ol", g);
							continue
						}
						if (e._listLevel) {
							o(e, "ul", 1);
				...
				function p(t, n) {
					...
					return e.each(a, function (e, i) {
						...
						return 0 === i.indexOf("mso-comment") ? void t.remove() : void(0 !== i.indexOf("mso-") && ("all" == m || h && h[i]) && (o[i] = e))
				...
				var m, h, g = d.content;
				if (g = g.replace(/<b[^>]+id="?docs-internal-[^>]*>/gi, ""), g = g.replace(/<br class="?Apple-interchange-newline"?>/gi, ""), m = u.paste_retain_style_properties, m && (h = e.makeMap(m.split(/[, ]/))), u.paste_enable_default_filters !== !1 && a(d.content)) {
					...
					var b = new n({valid_elements: v, valid_children: "-li[p]"});
					...
					var C = y.parse(g);
					u.paste_convert_word_fake_lists !== !1 && f(C), d.content = new r({validate: u.validate}, b).serialize(C)
				}
			})
		}
		...
		e.add("paste", function (o) {
			...
			function s() {
				if ("text" == c.pasteFormat)c.pasteFormat = "html", o.fire("PastePlainTextToggle", {state: !1}); else if (c.pasteFormat = "text", o.fire("PastePlainTextToggle", {state: !0}), !a()) {
