!function (e, t) {
	...
	r("tinymce/codesampleplugin/Prism", [], function () {
		var e = {}, t = "undefined" != typeof e ? e : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}, n = function () {
			var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i, n = t.Prism = {
				util               : {
					...
					var c = r.textContent, u = {element: r, language: a, grammar: s, code: c};
					...
					e:for (var s in t)if (t.hasOwnProperty(s) && t[s]) {
						...
						for (var c = 0; c < l.length; ++c) {
							var u = l[c], d = u.inside, f = !!u.lookbehind, p = 0, m = u.alias;
							u = u.pattern || u;
							for (var h = 0; h < o.length; h++) {
								...
								if (!(g instanceof i)) {
									...
									if (v) {
										f && (p = v[1].length);
										var b = v.index - 1 + p, v = v[0].slice(p), y = v.length, C = b + y, x = g.slice(0, b + 1), w = g.slice(C + 1), N = [h, 1];
										x && N.push(x);
										var E = new i(s, d ? n.tokenize(v, d) : v, m);
										N.push(E), w && N.push(w), Array.prototype.splice.apply(o, N)
									}
								}
							}
						}
			...
			if (r.stringify = function (e, t, i) {
				...
				var r = JSON.parse(e.data), i = r.language, o = r.code, a = r.immediateClose;
		...
		return "undefined" != typeof module && module.exports && (module.exports = n), "undefined" != typeof global && (global.Prism = n), n.languages.markup = {
			...
			"style-attr": {
				...
				inside : {
					"attr-name"   : {
						pattern: /^\s*style/i,
						inside : n.languages.markup.tag.inside
					}, punctuation: /^\s*=\s*['"]|['"]\s*$/, "attr-value": {pattern: /.+/i, inside: n.languages.css}
				},
				alias  : "language-css"
			}
			...
			markup: {pattern: /<[^?]\/?(.*?)>/, inside: n.languages.markup},
			php   : /\{\{\{PHP[0-9]+\}\}\}/
		})), n.languages.python = {
		...
		return {isCodeSample: e, trimArg: t}
		...
		function r(e) {
			var t = [{text: "HTML/XML", value: "markup"}, {text: "JavaScript", value: "javascript"}, {
				text : "CSS",
				value: "css"
			}, {text: "PHP", value: "php"}, {text: "Ruby", value: "ruby"}, {
				text : "Python",
				value: "python"
		...
		t.add("codesample", function (t, s) {
			...
			}), t.addButton("codesample", {cmd: "codesample", title: "Insert/Edit code sample"}), t.on("init", l))
		})
