tinymce.PluginManager.add("template", function (e) {
	...
	function n(t) {
		...
		if (!t || 0 === t.length) {
			...
			return void e.notificationManager.open({text: l, type: "info"})
		}
		tinymce.each(t, function (e) {
			...
			items    : [{
				...
				items  : [{
					type : "container",
					label: "Templates",
					items: {type: "listbox", label: "Templates", name: "template", values: s, onselect: n}
				}]
	...
	function r(t, n) {
		...
		var i = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "), o = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "), a = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), s = "January February March April May June July August September October November December".split(" ");
	...
	function i(t) {
		var n = e.dom, r = e.getParam("template_replace_values");
	...
	function a(t, n) {
		...
		var l, c, u = e.dom, d = e.selection.getContent();
