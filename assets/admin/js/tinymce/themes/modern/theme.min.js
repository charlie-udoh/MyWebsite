!function () {
	...
	s("1", tinymce.Env), s("2", tinymce.EditorManager), s("3", tinymce.ThemeManager), s("8", tinymce.util.Tools), s("9", tinymce.ui.Factory), s("a", tinymce.DOM), a("b", ["8", "9"], function (e, t) {
		var n = "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image", r = function (n, r, i) {
			var o, a = [];
		...
		var a = function (e) {
			...
			var d, f = a.settings, p = function () {
				...
				var r, i, d, p, h, g, v, b, y = f.inline_toolbar_position_handler;
				if (!a.removed) {
					if (!t || !t.toolbar.panel)return void s(a);
					v = ["bc-tc", "tc-bc", "tl-bl", "bl-tl", "tr-br", "br-tr"], h = t.toolbar.panel, n && h.show(), d = m(t.element), i = e.getRect(h.getEl()), p = e.getRect(a.getContentAreaContainer() || a.getBody()), b = 25, "inline" !== e.getStyle(t.element, "display", !0) && (d.w = t.element.clientWidth, d.h = t.element.clientHeight), a.inline || (p.w = a.getDoc().documentElement.offsetWidth), a.selection.controlSelection.isResizable(t.element) && d.w < b && (d = o.inflate(d, 0, 8)), r = o.findBestRelativePosition(i, d, p, v), d = o.clamp(d, p), r ? (g = o.relativePosition(i, d, r), l(h, u(y, g.x, g.y, d, p, i))) : (p.h += i.h, d = o.intersect(p, d), d ? (r = o.findBestRelativePosition(i, d, p, ["bc-tc", "bl-tl", "br-tr"]), r ? (g = o.relativePosition(i, d, r), l(h, u(y, g.x, g.y, d, p, i))) : l(h, u(y, d.x, d.y, d, p, i))) : h.hide()), c(h, r, function (e, t) {
						return e === t
					})
				}
			}, g     = function (e) {
				return function () {
					var t = function () {
						a.selection && h(C(a.selection.getNode()), e)
					};
				...
				var t;
				return e.toolbar.panel ? (e.toolbar.panel.show(), void h(e)) : (v(), t = i.create({
					type     : "floatpanel",
					role     : "dialog",
				...
				}), e.toolbar.panel = t, t.renderTo(document.body).reflow(), void h(e))
			}, y     = function () {
				t.each(p(), function (e) {
					e.panel && e.panel.hide()
				})
			...
			a.on("click keyup setContent ObjectResized", function (e) {
				("setcontent" !== e.type || e.selection) && n.setEditorTimeout(a, function () {
					var e;
					e = C(a.selection.getNode()), e ? (y(), b(e)) : y()
				})
		...
		var r = function (e) {
			...
			return function (l) {
				var c = l.control, u = c.parents().filter("panel")[0], d = u.find("#" + n)[0], f = s(r, n);
		...
		var u = function (e) {
			...
			var h, g, v, b = e.settings;
			return m.skinUiCss && n.styleSheetLoader.load(m.skinUiCss, l.fireSkinLoaded(e)), h = p.panel = t.create({
				type   : "panel",
				role   : "application",
				classes: "tinymce",
				...
				type       : "resizehandle", direction: b.resize, onResizeStart: function () {
			...
			}), e.fire("BeforeRenderUI"), e.on("SwitchMode", u(h)), h.renderBefore(m.targetNode).reflow(), b.readonly && e.setMode("readonly"), b.width && n.setStyle(h.getEl(), "width", b.width), e.on("remove", function () {
				h.remove(), h = null
			}), a.addKeys(e, h), o.addContextualToolbars(e), {
				iframeContainer: h.find("#iframe")[0].getEl(),
				editorContainer: h.getEl()
			}
		};
		return {render: p}
		...
		var c = function (e, c, u) {
			...
			var m = function () {
				...
				return d ? void(d.visible() || h()) : (d = c.panel = t.create({
				...
				}), e.fire("BeforeRenderUI"), d.renderTo(f || document.body).reflow(), s.addKeys(e, d), h(), a.addContextualToolbars(e), e.on("nodeChange", m), e.on("activate", h), e.on("deactivate", g), void e.nodeChanged())
			};
		...
		var s = function (n, o, s) {
			var l = n.settings, c = l.skin !== !1 && (l.skin || "lightgray");
			if (c) {
				var u = l.skin_url;
