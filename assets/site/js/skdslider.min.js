(function (e) {
	...
	e.skdslider.createNav = function (t, n, r) {
		...
		for (i = 0; i < n.length; i++) {
			...
			if (i == 0)s += '<li class="current-slide slide-nav-' + i + '"><a>' + o + "</a></li>"; else s += '<li class="slide-nav-' + i + '"><a>' + o + "</a></li>"
		}
		s += "</ul>";
		if (r.showNav == true) {
			t.append(s);
		...
		if (r.showPlayButton == true) {
			...
			t.find("a.play-control").click(function () {
				if (r.autoSlide == true) {
					...
					if (r.currentSlide + 1 == n.length)targetSlide = 0; else targetSlide = r.currentSlide + 1;
					clearTimeout(r.interval);
					e.skdslider.playSlide(t, n, r, targetSlide)
				}
				return false
	...
	e.skdslider.prev = function (t, n, r) {
		if (r.currentSlide == 0)targetSlide = n.length - 1; else targetSlide = r.currentSlide - 1;
		clearTimeout(r.interval);
		r.currentState = "play";
		r.running = false;
		e.skdslider.playSlide(t, n, r, targetSlide);
