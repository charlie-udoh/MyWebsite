...
<div class="row">
	<div class="col-md-12">
		<a class="btn btn-primary pull-right" style="margin: 5px 10px 2px 10px;" href="category_form.php?mode=new">Add
			New</a>
		<!-- Advanced Tables -->
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover display" id="category_grid">
						<thead>
						<tr>
							<th>Name</th>
							<th>Description</th>
...
<script>
	$(document).ready(function () {
		$('#category_grid').DataTable({
			...
			"serverSide": true,
			"ajax"      : {
				url  : "lib/get_categories.php", // json datasource
				type : "post",  // type of method  ,GET/POST/DELETE
				error: function () {
					$("#category_grid_processing").css("display", "none");
				}
			}
		});
	});
